                    ...
                    <form class="" novalidate action="/login" method="POST">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="password" name="password"
                                class="w-full border border-gray-200 focus:ring-primary focus:border-primary rounded-lg px-5 py-2" placeholder="Kode Pin" />
                            <button
        ...
        <div class="mx-10 md:mx-20 ">
            <div class="container mx-auto">
                <a href="/showcase/lapak"
                    class="flex justify-center items-center bg-slate-300 shadow-md hover:shadow-lg transition duration-300 ease-in-out py-3 md:py-8 px-4 rounded-lg md:rounded-2xl">
