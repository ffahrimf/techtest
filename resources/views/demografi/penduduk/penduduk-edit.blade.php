                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" name="nik"
                                                    ...
                                                    placeholder="Nomor Induk Kependudukan" value="{{old('nik', $penduduk->nik)}}"
                                                    required>
                                                @error('nik')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_kk"
                                                    ...
                                                    placeholder="Nomor Kartu Keluarga" value="{{old('no_kk', $penduduk->no_kk)}}" required>
                                                @error('no_kk')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama"
                                                    ...
                                                    placeholder="Nama Lengkap" value="{{old('nama', $penduduk->nama)}}" required>
                                                @error('nama')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="alamat"
                                                    ...
                                                    id="alamat" placeholder="Alamat Lengkap" value="{{old('alamat', $penduduk->alamat)}}"
                                                    required>
                                                @error('alamat')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select name="rt" class="form-control @error('rt') is-invalid @enderror" id="rt" required>
                                                    <option value="" disabled selected>Pilih RT</option>
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        @php
                                                            $rtValue = str_pad($i, 2, '0', STR_PAD_LEFT);
                                                        @endphp
                                                        <option value="{{ $rtValue }}" {{ old('rt', $penduduk->rt) == $rtValue ? 'selected' : '' }}>{{ $rtValue }}</option>
                                                    @endfor
                                                </select>
                                                @error('rt')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select name="rw" class="form-control @error('rw') is-invalid @enderror" id="rw" required>
                                                    <option value="" disabled selected>Pilih RW</option>
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        @php
                                                            $rwValue = str_pad($i, 2, '0', STR_PAD_LEFT);
                                                        @endphp
                                                        <option value="{{ $rwValue }}" {{ old('rw', $penduduk->rw) == $rwValue ? 'selected' : '' }}>{{ $rwValue }}</option>
                                                    @endfor
                                                </select>
                                                @error('rw')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="dusun"
                                                    ...
                                                    <option value="Pamekaran"
                                                        {{ old('dusun', $penduduk->dusun) == 'Pamekaran' ? 'selected' : '' }}>Pamekaran</option>
                                                    <option value="Cimaja"
                                                        {{ old('dusun', $penduduk->dusun) == 'Cimaja' ? 'selected' : '' }}>Cimaja</option>
                                                    <option value="Cimanglid"
                                                        {{ old('dusun', $penduduk->dusun) == 'Cimanglid' ? 'selected' : '' }}>Cimanglid</option>
                                                    <option value="Limusagung"
                                                        {{ old('dusun', $penduduk->dusun) == 'Limusagung' ? 'selected' : '' }}>Limusagung</option>
                                                    <option value="Mangunjaya"
                                                        {{ old('dusun', $penduduk->dusun) == 'Mangunjaya' ? 'selected' : '' }}>Mangunjaya</option>
                                                    <option value="Nanggeleng"
                                                        {{ old('dusun', $penduduk->dusun) == 'Nanggeleng' ? 'selected' : '' }}>Nanggeleng</option>
                                                    <option value="Darawati"
                                                        {{ old('dusun', $penduduk->dusun) == 'Darawati' ? 'selected' : '' }}>Darawati</option>
                                                </select>
                                                @error('dusun')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="agama"
                                                    ...
                                                    <option value="Konghucu"
                                                        {{ old('agama' , $penduduk->agama) == 'Konghucu' ? 'selected' : '' }}>Konghucu
                                                    </option>
                                                </select>
                                                @error('agama')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status_perkawinan"
                                                    ...
                                                    <option value="Belum Kawin"
                                                        ...
                                                        Belum Kawin</option>
                                                    <option value="Kawin"
                                                        {{ old('status_perkawinan', $penduduk->status_perkawinan) == 'Kawin' ? 'selected' : '' }}>Kawin
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="pendidikan"
                                                    ...
                                                    <option value="Tidak Sekolah"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak
                                                        Sekolah</option>
                                                    <option value="SD"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'SD' ? 'selected' : '' }}>SD</option>
                                                    <option value="SMP"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'SMP' ? 'selected' : '' }}>SMP</option>
                                                    <option value="SMA"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'SMA' ? 'selected' : '' }}>SMA</option>
                                                    <option value="D1"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'D1' ? 'selected' : '' }}>D1</option>
                                                    <option value="D2"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'D2' ? 'selected' : '' }}>D2</option>
                                                    <option value="D3"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'D3' ? 'selected' : '' }}>D3</option>
                                                    <option value="S1"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'S1' ? 'selected' : '' }}>S1</option>
                                                    <option value="S2"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'S2' ? 'selected' : '' }}>S2</option>
                                                    <option value="S3"
                                                        {{ old('pendidikan', $penduduk->pendidikan) == 'S3' ? 'selected' : '' }}>S3</option>
                                                </select>
                                                @error('pendidikan')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="golongan_darah"
                                                    ...
                                                    <option value="A"
                                                        {{ old('golongan_darah', $penduduk->golongan_darah) == 'A' ? 'selected' : '' }}>A</option>
                                                    <option value="B"
                                                        {{ old('golongan_darah', $penduduk->golongan_darah) == 'B' ? 'selected' : '' }}>B</option>
                                                    <option value="AB"  
                                                        {{ old('golongan_darah', $penduduk->golongan_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                                    <option value="O"
                                                        {{ old('golongan_darah', $penduduk->golongan_darah) == 'O' ? 'selected' : '' }}>O</option>
                                                </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="shdk" class="form-control @error('shdk') is-invalid @enderror" id="shdk" required>
                                                    <option value="">Pilih Status</option>
                                                    <option value="Ayah" {{ old('shdk', $penduduk->shdk) == 'Ayah' ? 'selected' : '' }}>Ayah</option>
                                                    <option value="Ibu" {{ old('shdk', $penduduk->shdk) == 'Ibu' ? 'selected' : '' }}>Ibu</option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ayah"
                                                    ...
                                                    id="ayah" placeholder="Nama Ayah" value="{{old('ayah', $penduduk->ayah)}}"
                                                    required>
                                                @error('ayah')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ibu"
                                                    ...
                                                    id="ibu" placeholder="Nama Ibu" value="{{old('ibu', $penduduk->ibu)}}"
                                                    required>
                                                @error('ibu')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kepala_keluarga"
                                                    ...
                                                    value="{{old('kepala_keluarga', $penduduk->kepala_keluarga)}}" required>
