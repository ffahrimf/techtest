                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="visi"
                                        class="form-control @error('visi') is-invalid @enderror" id="visi"
                                        placeholder="Visi" rows="8" required>{{ old('visi', $visiMisi->visi) }}</textarea>
                                    @error('visi')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="misi"
                                        class="form-control @error('misi') is-invalid @enderror" id="misi"
                                        placeholder="Misi" rows="8" required>{{ old('misi', $visiMisi->misi) }}</textarea>
                                    @error('misi')
                                        <span class="invalid-feedback text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
...
<!-- JavaScript to add automatic numbering to Misi textarea -->
<script>
