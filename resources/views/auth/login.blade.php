...
<section class="bg-gray-50 dark:bg-gray-900 font-montserrat">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="/" class=" flex items-center mb-6 text-md md:text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-10 h-10 mr-2" src="assets/img/mountain.png" alt="logo">
          Sistem Informasi <br class="md:hidden">Desa Payungagung    
      </a>
